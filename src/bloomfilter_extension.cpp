...
static void LoadInternal(DatabaseInstance &instance) {
	...
	auto bloomfilter_scalar_function = ScalarFunction("bloomfilter", {LogicalType::VARCHAR}, LogicalType::VARCHAR, BloomfilterScalarFun);
	ExtensionUtil::RegisterFunction(instance, bloomfilter_scalar_function);

	// Register another scalar function
	auto bloomfilter_openssl_version_scalar_function = ScalarFunction("bloomfilter_openssl_version", {LogicalType::VARCHAR},
	                                                            LogicalType::VARCHAR, BloomfilterOpenSSLVersionScalarFun);
...
std::string BloomfilterExtension::Name() {
	return "bloomfilter";
}
